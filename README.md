# CUC DeepSeek API 使用手册

「测试」第一版：2025 年 04 月 11 日

「测试」第二版：2025 年 04 月 14 日

「测试」第三版：2025 年 04 月 17 日

<u>**特别注意：CUC API 仅可以在学校网络环境下调用，请确保在操作前连接学校网络，否则 API 将无法使用！**</u>
...
- **安装之前请先检查您的电脑中是否自带 curl 工具**
  ...
  ![image](images/2025-04-15-07-49-03-image.png)
  
  在弹出的窗口中输入 `curl --help` 。
  
  ![image](images/2025-04-15-07-49-53-image.png)
  
  如果您的电脑有与上图类似的输出，则表示 curl 工具已经正常安装。否则**请参考下面的安装流程**：[CURL windows下安装及常用命令指南](https://blog.csdn.net/qq_42102911/article/details/127172463)。
...
- **示例响应**  
  ...
  ![image](images/2025-04-15-08-17-54-image.png)
...
1. **获取管理员权限**  
   ...
   ![image](images/2025-04-15-07-45-48-image.png)
...
2. **选择系统对应的软件源**
   ...
   ![image](images/2025-04-15-07-45-53-image.png)
...
4. **替换软件源内容**  
   ...
   ![image](images/2025-04-15-07-45-58-image.png)
...
2. **安装 curl**  
   ...
   ![image](images/2025-04-15-07-46-04-image.png)
...
- **示例响应**  
  ...
  ![image](images/2025-04-15-07-46-15-image.png)
...
1. **使用VSCode代码编辑器编写代码**
   ...
   ![image](images/2025-04-15-08-21-13-image.png)
...
2. **配置 Python 清华源**
   ...
   ![image](images/2025-04-15-08-21-49-image.png)
   
   点击右上角的 “切换面板” 按钮，弹出下方的终端界面。
   
   ![image](images/2025-04-15-08-22-20-image.png)
...
3. **安装 requests 库**
   ...
   ![image](images/2025-04-15-08-26-06-image.png)
...
- **代码模板**  
  ...
  ![image](images/2025-04-15-08-27-57-image.png)
...
1. **选择模式**  
   ...
   ![image](images/2025-04-15-08-30-30-image.png)
   
   `普通模式` 就是在提问后将思考过程和结果**一次性提供**，您可能需要等待一小段时间才能看到生成结果。下面是 “普通模式” 的使用示例：
   
   ![image](images/2025-04-15-08-31-58-image.png)
   
   ![image](images/2025-04-15-08-32-12-image.png)
   
   `流式模式` 则是在提问后将思考过程和结果**逐字输出**，您可以立即看见人工智能的输出过程。下面是 “流式模式” 的使用示例：
   
   ![image](images/2025-04-15-08-31-10-image.png)
