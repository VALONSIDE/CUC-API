...
- **安装之前请先检查您的电脑中是否自带 curl 工具**
  ...
  ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-49-03-image.png)
  
  在弹出的窗口中输入 `curl --help` 。
  
  ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-49-53-image.png)
...
- **示例响应**  
  ...
  ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-17-54-image.png)

- **自定义消息内容**  
  修改 `system` 或 `user` 字段内容（如设置日语机器人），响应结果中 `content` 会按规则返回：
  
  ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-18-44-image.png)
...
1. **获取管理员权限**  
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-45-48-image.png)
...
2. **选择系统对应的软件源**
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-45-53-image.png)
...
4. **替换软件源内容**  
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-45-58-image.png)
...
2. **安装 curl**  
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-46-04-image.png)
...
- **示例响应**  
  ...
  ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-46-15-image.png)

- **自定义消息内容**  
  修改 `system` 或 `user` 字段内容（如设置日语机器人），响应结果中 `content` 会按规则返回：
  
  ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-46-22-image.png)
...
1. **使用VSCode代码编辑器编写代码**
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-19-49-image.png)
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-20-20-image.png)
   
   您可以打开 VSCode 并在左侧插件栏目搜索 `Chinese` ，下载并安装汉化插件。
   
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-21-13-image.png)
...
2. **配置 Python 清华源**
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-21-49-image.png)
   
   点击右上角的 “切换面板” 按钮，弹出下方的终端界面。
   
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-22-20-image.png)
...
3. **安装 requests 库**
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-26-06-image.png)
...
- **代码模板**  
  ...
  ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-27-57-image.png)
...
1. **选择模式**  
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-30-30-image.png)
   
   `普通模式` 就是在提问后将思考过程和结果**一次性提供**，您可能需要等待一小段时间才能看到生成结果。下面是 “普通模式” 的使用示例：
   
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-31-58-image.png)
   
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-32-12-image.png)
   
   `流式模式` 则是在提问后将思考过程和结果**逐字输出**，您可以立即看见人工智能的输出过程。下面是 “流式模式” 的使用示例：
   
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-31-10-image.png)
...
2. **开始对话**  
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-32-29-image.png)
...
1. 以 Debian 12 为例，从官网 https://www.postman.com/downloads/ 下载适合版本。
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-47-08-image.png)

2. 解压下载的 tar.gz 包。
   
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-47-12-image.png)

3. 启动 Postman 。
   
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-47-15-image.png)
...
1. **新建 HTTP 请求**  
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-47-55-image.png)
   
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-47-58-image.png)
...
2. **设置 Headers**  
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-08-39-14-image.png)
...
3. ```json
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-48-09-image.png)
...
4. 在上方的地址栏输入下面的API地址。
   ...
   ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-48-21-image.png)

#### 步骤三：发送请求并查看结果

- 点击 “Send“ ，查看下方显示响应内容，确认操作是否正确：
  
  ![image](https://github.com/VALONSIDE/CUC-API/tree/main/images/2025-04-15-07-48-32-image.png)
